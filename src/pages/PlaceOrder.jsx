  ...
  return (
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h[80vh] border-t'>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <input type="email" className='border border-gray-300 py-1.5 px-3.5 w-full' placeholder='E-mail address'/>
        ...
        <div className='flex gap-3'>
          <input type="number" className='border border-gray-300 py-1.5 px-3.5 w-full' placeholder='Zipcode'/>
          <input type="text" className='border border-gray-300 py-1.5 px-3.5 w-full' placeholder='Country'/>
        </div>
        <input type="number" className='border border-gray-300 py-1.5 px-3.5 w-full' placeholder='Phone'/>
      </div>
      {/* Right side */}
      <div className='mt-8'>
