        ...
        <div className='flex items-center justify-between py-5 font-medium'>
            ...
            <div className='flex items-center gap-6'>
                ...
                <Link to='/card' className='relative'>
                    <img src={assets.cart_icon} alt="card_icon" className='w-5 min-w-5' />
            ...
            <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-5/6' : 'w-0'}`}>
